...
const productExceptSelf = (nums) => {
    ...
    for (let i = numsFirstIndex; i < numsLastIndex; i++) {
        ...
        leftSideProducts[numsCurrentIndex][0] = (leftSideProducts[numsPreviousIndex] ?? 1) * leftSideProducts[numsCurrentIndex][0];
    }
    ...
    for (let i = numsLastIndex; i > numsFirstIndex; i--) {
        ...
        rightSideProducts[numsCurrentIndex][0] = (rightSideProducts[numsPreviousIndex] ?? 1) * rightSideProducts[numsCurrentIndex][0];
    }
    ...
    for (let i = numsFirstIndex; i <= numsLastIndex; i++) {
        ...
        results.push((leftSideProducts[leftSideProductsCurrentIndex] ?? 1) * (rightSideProducts[rightSideProductsCurrentIndex] ?? 1));
    }
